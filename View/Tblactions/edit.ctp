<div class="tblactions form">
    ...
    <fieldset>
        ...
        <?php
        echo $this->Form->input('ref_id', array('value' => $this->data['Tblaction']['ref_id']));
        echo $this->Form->input('owner_id', array('value' => $this->data['Tblaction']['owner_id']));
        echo $this->Form->input('user_id', array('value' => $this->data['Tblaction']['user_id']));
